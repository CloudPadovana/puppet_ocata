...
# ec2api.conf
  do_config { 'ec2_verbose': conf_file => '/etc/ec2api/ec2api.conf', section => 'DEFAULT', param => 'verbose', value => $controller_ocata::params::ec2_verbose, }
########
   ...
   do_config { 'ec2_default_auth_ca_cert': conf_file => '/etc/ec2api/ec2api.conf', section => 'DEFAULT', param => 'auth_ca_cert', value => $controller_ocata::params::cafile, }
   do_config { 'ec2_cafile': conf_file => '/etc/ec2api/ec2api.conf', section => 'DEFAULT', param => 'cafile', value => $controller_ocata::params::cafile, }
...
################       
 ...
 #  do_config { 'ec2_admin_user': conf_file => '/etc/ec2api/ec2api.conf', section => 'keystone_authtoken', param => 'admin_user', value => $controller_ocata::params::admin_user, }   
 #  do_config { 'ec2_admin_password': conf_file => '/etc/ec2api/ec2api.conf', section => 'keystone_authtoken', param => 'admin_password', value => $controller_ocata::params::admin_password, }   
 #  do_config { 'ec2_admin_tenant_name': conf_file => '/etc/ec2api/ec2api.conf', section => 'keystone_authtoken', param => 'admin_tenant_name', value => $controller_ocata::params::admin_tenant_name, }   
##################
